...
public class TestArrayList {
    public static void main(String[] args) {
        ...
        Estudiante e1 = new Estudiante("Avalos", "Matias", "gonzalo0avalos@gmail.com", "Facultad de Informática");
        listaEsts.add(e1);
        Estudiante e2 = new Estudiante("Lima", "Francisco", "gonzalo0avalos@gmail.com", "Facultad de Informática");
        listaEsts.add(e2);
        Estudiante e3 = new Estudiante("Fischer", "Matias", "gonzalo0avalos@gmail.com", "Facultad de Informática");
        listaEsts.add(e3);
        ...
        listaEsts.set(0, new Estudiante("Prueba", "Prueba", "pruebamail", "Facultad de Informática"));
