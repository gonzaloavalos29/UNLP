...
procedure actualizar1(c: centro; var centroMin1, centroMin2: integer; var nCentroMin1, nCentroMin2: string); 
{Actualizar los centros con menores cantidades de becarios}
    begin
...
procedure actualizar2(nUni1: string; cUni1: integer; var nUni2: string; var cUni2: integer); 
{Actualizar el nombre de la universidad con mas investigadores}
    begin
...
procedure procesarUniversidades(var invMax, centroMin1, centroMin2: integer; var nCentroMin1, nCentroMin2, invUni: string; 
var terminar: boolean);
    ...
    begin
        ...
        while (c.universidad = nombreUni) and (c.investigadores <> 0) do 
        {Mientras la universidad siga sienda la misma Y la cantidad de investigadores diferentes de 0...}
        begin
