{ Se leen datos de empleados de una empresa multinacional. De cada empleado se conoce su código de empleado (entre 1 y 2000),
* el código de país donde trabaja (entre 1 y 25), la antigüedad en años y el sueldo bruto en dólares. La lectura finaliza al
* ingresar el código de empleado 0.
* Realizar un programa que lea y almacene la información de los empleados en una estructura de datos adecuada. Una vez completada
* la carga, procese la información de los empleados, e informe:
* - el país con mayor cantidad de empleados
* - la cantidad de empleados de más de 10 años de antigüedad cuyo sueldo bruto no alcance los 1500 dólares.
* - el código del empleado que cobra mejor sueldo en cada país. }
...
procedure procesarDatos(empleados: vector_empleados; dimL: codigos_empleados; var v: vector_paises; var sueldos: vector_sueldos;
var cantEmp: integer);
var
	e: empleado;
	i: codigos_empleados;
begin
	for i:= 1 to dimL do begin
		e:= empleados[i]; // para mayor legibilidad
...
begin
	...
	writeln('La cant. de empleados con más de 10 años de antigüedad cuyo sueldo bruto no alcance los 1500 dólares es: ', 
	cantEmpleados);
end.
