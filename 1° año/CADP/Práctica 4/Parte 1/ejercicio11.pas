...
procedure cargarVector(var v: vector);
	...
	begin
		for i:= 1 to dimF do begin
			write('Titulo de la foto: '); readln(v[i].titulo);
			...
			write('La cantidad de comentarios que haya recibido: '); readln(v[i].clicks);
...
begin
	...
	writeln;
	writeln('El titulo de la foto mas vista de la pagina es: ', tFotoMax);
