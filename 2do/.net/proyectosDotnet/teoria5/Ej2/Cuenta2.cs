...
public class Cuenta2 {
    ...
    private readonly static List<Cuenta2> s_listaCuentas = new List<Cuenta2>();
    ...
    public Cuenta2 Depositar(int suma) {
        _saldo += suma;
    ...
    public Cuenta2 Extraer(int suma) {
    ...
    public static List<Cuenta2> GetCuentas() {
        return new List<Cuenta2>(s_listaCuentas); //Devolver un clon del listado interno de la Clase
    }
}