...
public class TestArrayList {
	public static void main(String[] args) {
		...
		// INCISO B
		// La diferencia está en el acceso a esos numeros, en ArrayList es directo mientras que en la lista enlazada el acceso es más ineficiente ya que se debe recorrer de forma secuencial.
		...
		Estudiante e1 = new Estudiante("Avalos", "Gonzalo", "gonzalomail", "Facultad de Informatica");
		listaEsts.add(e1);
