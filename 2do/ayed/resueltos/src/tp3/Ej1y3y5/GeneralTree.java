...
public class GeneralTree<T> {
	...
	public void numerosImparesMayoresQuePreOrden(Integer n, List<Integer> l) {
	...
	public void numerosImparesMayoresQueInOrden(Integer n, List<Integer> l) {
		List<GeneralTree<T>> children = this.getChildren();
		if (this.hasChildren()) {
	...
	private boolean esAncestroBusqueda(T a, T b) {
		...
		while (!cola.isEmpty() && (!res)) {
			ab = cola.dequeue();
			if (ab.getData().equals(b) && (!res)) return false; // Encontré B antes que A
