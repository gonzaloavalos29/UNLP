...
// el primer if verifica si al menos uno de los arboles esta vacio, si es asi, pregunta si ambos arboles estan vacios, en caso afirmativo tienen
// la misma estructura, en caso contrario, no es prefijo
			return arbol1.isEmpty() && arbol2.isEmpty(); 
		return esPrefijoHelper(arbol1, arbol2); // si entre aca es porque los 2 arboles tienen al menos un dato y puedo hacer la comparacion
	}
	...
	public static void main(String[] args) {
		...
		ab3.addLeftChild(new BinaryTree<Integer>(1));
