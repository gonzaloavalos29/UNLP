#!/bin/bash
# Realizar un script que solicite al usuario 2 números, los lea de la entrada Standar
# e imprima la multiplicación, suma, resta y cuál es el mayor de los números leídos.
