    ...
    public static void main(String[] args) {
        ...
        while (dimL1 < dimF1 && !(nombre.equals("ZZZ"))) {
            ...
            while (dimL2 < dimF2 && !(nombre.equals("ZZZ"))) {
                ...
                matrizPersonas[dimL1][dimL2] = participante; // Asignarlo a su respectivo lugar en la matriz
                dimL2++;
        ...
        for (i = 0; i < dimL1; i++) {
            ...
            for (j = 0; j < dimL2; j++) {
                System.out.println("Persona entrevistada: " + matrizPersonas[i][j].toString());
            }
        }
    }
}
