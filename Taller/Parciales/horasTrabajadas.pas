...
begin
	...
	end else begin // o sea, si el valor es menor
...
begin
	if (l = nil) then
		...
		moduloC:= l^.data.horasTrabajadas + moduloC(l^.sig);
end;
...
BEGIN
	...
	writeln('Leer lista');
	imprimirLista(l);
	writeln('Se trabajo un total de ', moduloC(l), ' horas');
END.
