...
type
	...
	vectorGeneros = array[r_genero] of pelicula;
// MÓDULO A
...
begin
	...
	while (p.codPeli <> corte) do begin
		insertarOrdenado(l, p); // Ordenar por código de género
		writeln;
		leerPelicula(p);
	end;
end;
...
procedure burbuja(var v: vectorGeneros; dimL: integer);
var
	i, j: integer;
	temp: pelicula;
begin
...
begin
	...
	burbuja(v, 8);
	// MÓDULO D
	writeln('El código de la película con mayor puntuación es el código ', v[1].codPeli, ' con ', v[1].puntProm:2:2, ' de puntaje');
	writeln('El código de la película con menor puntuación es el código ', v[8].codPeli, ' con ', v[8].puntProm:2:2, ' de puntaje');
end.
