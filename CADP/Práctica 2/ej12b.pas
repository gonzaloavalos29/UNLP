...
procedure rendEconomico(var toneladasValor: real; var localidad: string; var ha: integer);
	var
		tipoZona: integer;
	begin
...
begin
	...
	maxCampoR:= -1;
	minCampoR:= 999999;
	rendEconomico(rendEcon, localidad, hectareas);
	while (hectareas <> 900) or (localidad <> 'Saladillo') do begin {Registrar los rendimientos economicos de los campos hasta que las hectareas sean 900 y la localidad sea 'Saladillo'}
	...
	writeln('La localidad del campo con mayor rendimiento economico esperado es: ', maxCampoL);
	writeln('La localidad del campo con menor rendimiento economico esperado es: ', minCampoL);
	writeln('El rendimiento economico promedio es: ', (rendEconPromedio/veces):2:2);
end.
